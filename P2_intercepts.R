...
predicted_returns_1 <- (regression_1$coefficients[1] + regression_1$coefficients[2]*ff_1_market_excess_return+
                          regression_1$coefficients[3]*ff_2_SMB+
                          regression_1$coefficients[4]*ff_3_HML)
predicted_returns_2 <- (regression_2$coefficients[1] + regression_2$coefficients[2]*ff_1_market_excess_return+
                          regression_2$coefficients[3]*ff_2_SMB+
                          regression_2$coefficients[4]*ff_3_HML)
predicted_returns_3 <- (regression_3$coefficients[1] + regression_3$coefficients[2]*ff_1_market_excess_return+
                          regression_3$coefficients[3]*ff_2_SMB+
                          regression_3$coefficients[4]*ff_3_HML)
predicted_returns_4 <- (regression_4$coefficients[1] + regression_4$coefficients[2]*ff_1_market_excess_return+
                          regression_4$coefficients[3]*ff_2_SMB+
                          regression_4$coefficients[4]*ff_3_HML)
predicted_returns_5 <- (regression_5$coefficients[1] + regression_5$coefficients[2]*ff_1_market_excess_return+
                          regression_5$coefficients[3]*ff_2_SMB+
                          regression_5$coefficients[4]*ff_3_HML)
predicted_returns_6 <- (regression_6$coefficients[1] + regression_6$coefficients[2]*ff_1_market_excess_return+
